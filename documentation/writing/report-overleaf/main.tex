...
Lastly, using the power spectral density values, the spectral entropy of each channel was obtained.
...
\begin{figure}[H]
    \centering
    \centerline{\includegraphics[width=1.2\textwidth]{images/spiking/rates_gp2.png}}
...
\begin{figure}[H]
    \centering
    \centerline{\includegraphics[width=1.2\textwidth]{images/spiking/rates_stn2.png}}
...
\begin{figure}[H]
    \centering
    \centerline{\includegraphics[width=1.2\textwidth]{images/spiking/rates_both2.png}}
